...
const CreateBlog = () => {
    ...
    const createBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const url = `${import.meta.env.VITE_BASE_URL}${import.meta.env.VITE_CREATE_BLOG}`;
            
            // Now axios uses the correct local URL
            const res = await axios.post(url, { title, category }, {
                headers: {
