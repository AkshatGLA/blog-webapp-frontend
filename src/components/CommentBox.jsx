...
const CommentBox = ({ selectedBlog }) => {
    ...
    useEffect(() => {
        const getAllCommentsOfBlog = async () => {
            try {
const url = `${import.meta.env.VITE_BASE_URL}/comment/${selectedBlog._id}/comment/all`;
const res = await axios.get(url);
    ...
    const commentHandler = async () => {
        try {
const url = `${import.meta.env.VITE_BASE_URL}/comment/${selectedBlog._id}/create`;
const res = await axios.post(url, { content }, {
    ...
    const deleteComment = async (commentId) => {
        try {
            const url = `${import.meta.env.VITE_BASE_URL}/comment/${commentId}/delete`;
    ...
    const editCommentHandler = async (commentId) => {
        try {
            const url = `${import.meta.env.VITE_BASE_URL}/comment/${commentId}/edit`;
const res = await axios.put(url,
     ...
     const likeCommentHandler = async (commentId) => {
         try {
             const url = `${import.meta.env.VITE_BASE_URL}/comment/${commentId}/like`;
const res = await axios.get(url,
                 {
                     withCredentials: true,
                 }
